...
<div class="refresh-row">
    ...
    Actualizando en <strong id="cnt" style="color:var(--teal);margin:0 3px;">10</strong>s
</div>
...
<div class="scard" style="animation-delay:<?= $i*60 ?>ms">
    <div class="scard-inner">
        ...
        <div class="scard-body">
            ...
            <!-- FECHAS EXPANDIBLES (solo recurrente) -->
            <?php if ($esRec): ?>
...
function openModal(ids) { document.getElementById('modal_ids').value = ids; document.getElementById('modalBg').classList.add('on'); }
...
function toggleFechas(btn, id) {
    ...
    if(last.nodeType===3) last.textContent = list.classList.contains('open') ? ' Ocultar fechas' : ` Ver ${n} fechas específicas`;
}
</script>
</body>
</html>