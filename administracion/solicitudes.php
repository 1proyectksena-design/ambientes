...
.hdr-title h1{font-size:20px;font-weight:700;color:#fff;letter-spacing:-.01em}
...
.btn-hdr-ghost{background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.13);color: #ffff}
